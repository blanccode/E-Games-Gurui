...
(0,_paypal_paypal_js__WEBPACK_IMPORTED_MODULE_0__.loadScript)({
  "client-id": "EPAJhzkROmLmeYW2cmS6kN8ofSC2utNcPDx63V4sLjHVCGUDsCY6dYeUdY9k6xE1y443O1y2ZxmdQuxs"
}).then(function (paypal) {
  paypal.Buttons().render("#your-container-element")["catch"](function (error) {
...
/******/ __webpack_require__.O(0, ["css/app","/js/vendor"], () => (__webpack_exec__("./resources/js/app.js"), __webpack_exec__("./resources/js/script.js"), __webpack_exec__("./resources/css/app.css")));
