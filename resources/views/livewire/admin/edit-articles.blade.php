...
<div >
    <label>Bearbeite Artikel</label>
{{--{{$article}}--}}
    <x-admin.modal :model="$article" model-name="Artikel"/>

    <form class="pb-4 rounded-b-xl card-bg-100 p-3"  wire:submit.prevent="updateNews" >
        ...
        <div class=" ">
            ...
            <div class="flex justify-center w-9/12 m-auto" >
                @if(!$imageFile)
                    ...
                    <img class=" rounded-news w-full "  src="{{url('storage/articles/images/' . $article->image)}}"/>
            ...
            <textarea wire:model.defer="newsInput" class="accent-bg textarea w-full text-gray-200 rounded-lg" type="text" name="text" required >
