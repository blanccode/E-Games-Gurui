    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex-col align-bottom justify-between">
            ...
            @forelse(auth()->user()->follows as $follow)
                    <button wire:click="follow({{$user->id}})" class="accent-blue-8 rounded-xl p-2 px-10 text-white font-semibold flex">
        ...
        <div data-social-container class="yt-icon-container flex ">
