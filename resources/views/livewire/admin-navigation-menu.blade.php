<nav x-data="{ open: false }" class="card-bg text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 text-white text lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="sm:ml-10 sm:flex ">
                ...
                <div class="hidden text-white space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('admin.news.index') }}" :active="request()->routeIs('admin.news.index')">
                        {{ __('News') }}
                    </x-jet-nav-link>
                </div>
            </div>
                ...
                <div class="ml-3 relative text-gray-200 ">
                    <x-jet-dropdown class=" text-gray-200" align="right" width="48">
                        ...
                        <x-slot name="content" class="">
                            ...
                            <x-jet-dropdown-link class="text-gray-300" href="{{ route('admin.dashboard.index') }}">
                                {{ __('Dashboard') }}
                            </x-jet-dropdown-link>
                            <x-jet-dropdown-link href="{{ route('admin.archive.index') }}">
                                {{ __('Admin-Archive') }}
                            </x-jet-dropdown-link>
                            <x-jet-dropdown-link href="{{ route('admin.news.index') }}">
                                {{ __('News') }}
                            </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden card-bg">
        <div class="pt-2 pb-3 space-y-1 text-gray-100 card-bg">
            ...
            <x-jet-responsive-nav-link class="burger-link text-gray-200"  href="{{ route('admin.news.index') }}" :active="request()->routeIs('admin.news.index')">
                {{ __('News') }}
            </x-jet-responsive-nav-link>
        </div>
